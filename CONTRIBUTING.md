...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/tsconfig-utils
   cd tsconfig-utils
   ```
...
```sh
https://github.com/flex-development/tsconfig-utils/compare/main...$branch
```
...
[19]: https://github.com/flex-development/tsconfig-utils/discussions/new?category=q-a
