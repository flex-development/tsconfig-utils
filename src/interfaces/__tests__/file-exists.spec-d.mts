/**
 * @file Type Tests - FileExists
 * @module tsconfig-utils/interfaces/tests/unit-d/FileExists
 */

import type TestSubject from '#interfaces/file-exists'
import type { ModuleId } from '@flex-development/mlly'
import type { Awaitable } from '@flex-development/tsconfig-utils'

describe('unit-d:interfaces/FileExists', () => {
